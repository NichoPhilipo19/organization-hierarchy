...
export const sampleData: OrgNode[] = [
  ...
  { id: 'tc-head-mkt', parentId: 'tc-md', name: 'Nadya Paramitha', title: 'Head of Marketing' },
  {
    ...
    avatarUrl: avatar('tc-head-log'),
  },

  {
    id: 'tc-pm-1',
    parentId: 'tc-head-prod',
    name: 'Prita Anjani',
    title: 'Product Manager',
    avatarUrl: avatar('tc-pm-1'),
  },
  { id: 'tc-pm-2', parentId: 'tc-head-prod', name: 'Raka Danuarta', title: 'Product Manager' },
  {
    ...
    avatarUrl: avatar('tc-des-1'),
  },

  {
    id: 'tc-mkt-1',
    parentId: 'tc-head-mkt',
    name: 'Tegar Saputra',
    title: 'Growth Marketer',
    avatarUrl: avatar('tc-mkt-1'),
  },
  { id: 'tc-mkt-2', parentId: 'tc-head-mkt', name: 'Uswatun Nisa', title: 'Content Strategist' },

  {
    id: 'tc-log-1',
    parentId: 'tc-head-log',
    name: 'Wahyu Nugraha',
    title: 'Warehouse Supervisor',
    avatarUrl: avatar('tc-log-1'),
  }, // only-child
  {
    id: 'tc-wh-1',
    parentId: 'tc-log-1',
